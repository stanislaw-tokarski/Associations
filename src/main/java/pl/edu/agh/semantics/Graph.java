...
public class Graph {
    ...
    public static Graph ofMaps(List<Map<String, Integer>> associations, List<String> words) {
    ...
    public List<WeightPair<String>> getShortestPath(String source, String target){
        ...
        if (distancesByName.get(target) == Double.POSITIVE_INFINITY){
            System.out.println("Cannot find route from source to target!");
